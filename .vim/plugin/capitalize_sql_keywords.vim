function! s:CapitalizeSqlKeywords()
  ...
  let sql_words = 'select|and|not|is|as|from|order|group|alter|update|insert|delete|into|asc|desc|by|between|distinct|exists|if|else|end|current_date|current_time|coalesce|contains|interval|left|outer|join|on'
